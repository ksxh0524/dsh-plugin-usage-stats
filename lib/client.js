...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CONTRIBUTION = {
			...
			descriptors: [descriptor("overview", "filter", { file: "src/cordis.ts", line: 45, column: 9 })],
		};
		...
		var CSS = [
			...
			".usg-pv{all:unset;box-sizing:border-box;display:flex;align-items:center;justify-content:center;height:40px;border-radius:10px;cursor:pointer;font-size:18px;font-weight:500;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary)}",

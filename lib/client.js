...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			".usg-pop{position:absolute;top:calc(100% + 4px);left:0;z-index:61;border:.5px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-specific-menu);box-shadow:var(--dsw-shadow-lv3);padding:10px;font-size:12px;min-width:230px}",

...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			".usg-famSep{color:var(--dsw-alias-label-dimmed);margin:0 6px}",
		...
		function FamilyPill(props) {
			...
			return h(Anchored, {
				...
				trigger: h(
					...
					h(
						"span",
						{ className: "usg-famLabel" },
						totalText,
						hit === null ? null : h("span", { className: "usg-famSep", "aria-hidden": "true" }, "·"),
						hit === null ? null : "缓存命中 " + hit,
					),
				),
